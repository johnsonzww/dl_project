...
from model import \
    ImageReconstruction_fence_arbitraryFrameNum_large_FBconcat_AvgMeanPool as ImageReconstruction_fence_arbitraryFrameNum
    ...
    with tf.Graph().as_default():
        ...
        def get_online_data(path):
            ...
            dataset_F0 = dataset_F0.apply(
                tf.contrib.data.shuffle_and_repeat(buffer_size=30, count=None, seed=6)).map(
        ...
        F_max = tf.reduce_max(tf.concat(
            [F_pred_0_erosion[0], F_pred_0_erosion[1], F_pred_0_erosion[2], F_pred_0_erosion[3], F_pred_0_erosion[4]],
            -1), keepdims=True)
        F_min = tf.reduce_min(tf.concat(
            [F_pred_0_erosion[0], F_pred_0_erosion[1], F_pred_0_erosion[2], F_pred_0_erosion[3], F_pred_0_erosion[4]],
            -1), keepdims=True)
        B_max = tf.reduce_max(tf.concat([B_pred_0[0], B_pred_0[1], B_pred_0[2], B_pred_0[3], B_pred_0[4]], -1),
                              keepdims=True)
        B_min = tf.reduce_min(tf.concat([B_pred_0[0], B_pred_0[1], B_pred_0[2], B_pred_0[3], B_pred_0[4]], -1),
                              keepdims=True)
        ...
        for i in range(1):
            ...
            def compute_loss_2(FF02, FB02, FF12, FB12, FF32, FB32, FF42, FB42, F2, B2, A2, I2_lvl, I0_lvl, I1_lvl,
                               I3_lvl,
                               I4_lvl):
                sub_loss = 0
            ...
            twl, ttvl = compute_loss_2(FF_[0][2], FB_[0][2], FF_[1][2], FB_[1][2], FF_[3][2], FB_[3][2], FF_[4][2],
                                       FB_[4][2],
            ...
            tv_l += ttvl
            loss += ttvl
            twl, ttvl = compute_loss_2(FF_[1][0], FB_[1][0], FF_[2][0], FB_[2][0], FF_[3][0], FB_[3][0], FF_[4][0],
                                       FB_[4][0],
            ...
            twl, ttvl = compute_loss_2(FF_[0][1], FB_[0][1], FF_[2][1], FB_[2][1], FF_[3][1], FB_[3][1], FF_[4][1],
                                       FB_[4][1],
            ...
            twl, ttvl = compute_loss_2(FF_[0][3], FB_[0][3], FF_[1][3], FB_[1][3], FF_[2][3], FB_[2][3], FF_[4][3],
                                       FB_[4][3],
            ...
            twl, ttvl = compute_loss_2(FF_[0][4], FB_[0][4], FF_[1][4], FB_[1][4], FF_[2][4], FB_[2][4], FF_[3][4],
                                       FB_[3][4],
        ...
        # f = open("loss.txt", 'a')
        #
        # f.write(tf.as_string(warp_l) + " " + tf.as_string(tv_l-warp_l) + "\n")
        # f.close()
